        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Full Stack Developer building modern web apps, integrating front-end and back-end</h4>
              <p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Software Engineer skilled in designing, developing, and delivering efficient solutions
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
